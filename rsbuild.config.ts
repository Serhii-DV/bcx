  ...
  return defineConfig({
    ...
    source: {
      entry: {
        ...
        'bandcamp.content.page.album': {
          import: './src/bandcamp/content/pages/app.pageAlbum.ts',
          html: false,
        },
        'bandcamp.content.page.track': {
          import: './src/bandcamp/content/pages/app.pageTrack.ts',
          html: false,
        },
      },
    },
